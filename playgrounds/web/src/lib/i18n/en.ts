...
export const en: typeof vi = {
  ...
  "empty.greeting": "Hi! Ask me anything.",
  "empty.hint": "I learn from what you teach me. Type /teach <reply> if I don't know an answer.",
  "scroll.toBottom": "Jump to latest",
  "error.chat": "Couldn't send message — check your connection and try again.",
  "error.feedback": "Couldn't save vote.",
  "notFound.title": "Lost in conversation",
  "notFound.body": "The page you tried to open doesn't exist.",
