...
// Migrations live in @simlm/db, but the package doesn't export an
...
export default async function setup() {
  ...
  // 1) Ensure the simlm_test database exists. CREATE DATABASE can't run inside
  ...
  // 2) Reset schema in simlm_test and apply all migrations from packages/db.
